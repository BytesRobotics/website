...
$(window).load(function() {
    ...
    MESSAGES.push({
        delay: 0,
        text: '> Introducing Garbage Bytes.'
    });
    MESSAGES.push({
        delay: 1200,
        text: '> A Robotic Trash Can System'
    });
    MESSAGES.push({
        delay: 2200,
        text: '> Armed with next-generation autonomy systems'
    });
    MESSAGES.push({
        delay: 3600,
        text: '> Blessed with Emotional Intelligence '
    });
    $container = $('#container');
    $message = $('#message');
    $animate = $('#animate');
